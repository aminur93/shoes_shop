            ...
            <div class="col-sm-12">
                <div class="main-menu border-section border-top-0">
                    ...
                    <div class="brand-logo layout2-logo">
                        <a href="#">
                            <img src="{{ asset('img/Logo_png.png') }}" class="img-fluid blur-up lazyload" alt="">
                        </a>
                    </div>
                        ...
                        <div class="icon-nav">
                            <ul>
                                <li class="onhover-div mobile-search">
                                    <div>
                                        <img src="{{ asset('assets/front_end/assets/images/icon/search.png') }}" onclick="openSearch()" class="img-fluid blur-up lazyload" alt="">
                                ...
                                <li class="onhover-div mobile-cart">
                                    <div href="javascript:void(0)" onclick="openCart()"><img
                                                src="{{ asset('assets/front_end/assets/images/icon/cart.png') }}" class="img-fluid blur-up lazyload"
    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home text-center">
                <img src="{{ asset('assets/front_end/assets/images/home-banner/3.jpg') }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <div>
            <div class="home text-center">
                <img src="{{ asset('assets/front_end/assets/images/home-banner/4.jpg') }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
        ...
        <div>
            <div class="home text-center">
                <img src="{{ asset('assets/front_end/assets/images/home-banner/5.jpg') }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
            ...
            <div class="col">
                <div class="slide-6 no-arrow">
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat1.png') }}" alt=""></div>
                        </a>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat2.png') }}" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>casual shoes</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat3.png') }}" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>formal shoes</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat4.png') }}" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>flat</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat5.png') }}" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>heels</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{ asset('assets/front_end/assets/images/icon/cat6.png') }}" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>boots</h5>
        ...
        <div class="row partition2">
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="{{ asset('assets/front_end/assets/images/sub-banner.png') }}" class="img-fluid blur-up lazyload bg-img"
                                 alt="">
                        </div>
            ...
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="{{ asset('assets/front_end/assets/images/sub-banner1.png') }}" class="img-fluid blur-up lazyload bg-img"
                                 alt="">
                        </div>
                        <div class="contain-banner">
                            <div>
            ...
            <div class="col">
                <div class="product-4 product-m no-arrow">
                    <div class="product-box">
                        <div class="img-block">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/1.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/5.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info">
                    ...
                    <div class="product-box">
                        <div class="img-block">
                            <div class="lable-wrapper"><span class="lable1">new</span> <span class="lable2">30%
                                        off</span></div>
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/2.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/6.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info">
                                <button tabindex="0" onclick="openCart()" title="Add to cart">
                    ...
                    <div class="product-box">
                        <div class="img-block">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/3.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/7.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info">
                                <button tabindex="0" onclick="openCart()" title="Add to cart">
                    ...
                    <div class="product-box">
                        <div class="img-block">
                            <div class="lable-wrapper"><span class="lable1">new</span> <span class="lable2">30%
                                        off</span></div>
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/4.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('assets/front_end/assets/images/pro/8.jpg') }}"
                                                                             class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info">
                                <button tabindex="0" onclick="openCart()" title="Add to cart">
        ...
        <div class="row category-border">
            <div class="col-sm-4 border-padding">
                <div class="category-banner">
                    <div>
                        <img src="{{ asset('assets/front_end/assets/images/shoes/cat1.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="">
                    </div>
            ...
            <div class="col-sm-4 border-padding">
                <div class="category-banner">
                    <div>
                        <img src="{{ asset('assets/front_end/assets/images/shoes/cat2.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="">
                    </div>
                    <div class="category-box">
                        <a href="#">
                            <h2>women</h2>
            ...
            <div class="col-sm-4 border-padding">
                <div class="category-banner">
                    <div>
                        <img src="{{ asset('assets/front_end/assets/images/shoes/cat3.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="">
                    </div>
                    <div class="category-box">
                        <a href="#">
                            <h2>kids</h2>
                ...
                <div class="theme-card">
                    ...
                    <div class="offer-slider slide-1">
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/1.jpg') }}" alt=""></a>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/2.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/3.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                        ...
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/10.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/11.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/12.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                ...
                <div class="theme-card">
                    ...
                    <div class="offer-slider slide-1">
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/4.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/5.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/6.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                        ...
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/7.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/8.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                                                             src="{{ asset('assets/front_end/assets/images/shoes/9.jpg') }}" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="img-block">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/5.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/1.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                            <button tabindex="0" onclick="openCart()" title="Add to cart">
                                ...
                                <div class="product-box">
                                    <div class="img-block">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/6.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/2.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                            <button tabindex="0" onclick="openCart()" title="Add to cart">
                                ...
                                <div class="product-box">
                                    <div class="img-block">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/7.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/3.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                            <button tabindex="0" onclick="openCart()" title="Add to cart">
                                ...
                                <div class="product-box">
                                    <div class="img-block">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end//assets/images/pro/8.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/front_end/assets/images/pro/4.jpg') }}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                            <button tabindex="0" onclick="openCart()" title="Add to cart">
                        ...
                        <div class="footer-block">
                            <div class="footer-container">
                                ...
                                <div class="footer-contant">
                                    <div class="footer-logo"><img src="{{ asset('img/Logo_png.png') }}" alt="">
                                    </div>
                            ...
                            <div class="footer-container">
                                ...
                                <div class="footer-contant">
                                    <ul class="contact-details">
                                        <li>Kites Bangladesh Store</li>
                                        <li>Call Us: 01772-119941</li>
                                        <li>Email Us: <a href="#">Support@kitesbd.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                    <div class="footer-end">
                        <p><i class="fa fa-copyright" aria-hidden="true"></i> 2017-21 Kites Bangladesh powered by
                            AminurDev.io</p>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6 col-sm-12">
                    <div class="payment-card-bottom">
                        <ul>
                            <li>
                                <a href="#"><img src="{{ asset('assets/front_end/assets/images/icon/visa.png') }}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('assets/front_end/assets/images/icon/mastercard.png') }}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('assets/front_end/assets/images/icon/paypal.png') }}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('assets/front_end/assets/images/icon/american-express.png') }}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('assets/front_end/assets/images/icon/discover.png') }}" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="me-3" src="{{ asset('assets/front_end/assets/images/tools/pro/1.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="me-3" src="{{ asset('assets/front_end/assets/images/tools/pro/2.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="me-3" src="{{ asset('assets/front_end/assets/images/tools/pro/3.jpg') }}"></a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                            </a>
...
<!-- add to cart js -->
<script src="{{ asset('assets/front_end/assets/js/addtocart.js') }}"></script>
