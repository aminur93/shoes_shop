        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('logo.create') }}" class="btn btn-sm btn-primary  float-right"><i class="fas fa-plus"></i> Add Logo</a>
...
<script>
    ...
    $(document).on('change','.status_toggle', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('logo.status_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
