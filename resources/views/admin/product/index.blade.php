        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('products.create') }}" class="btn btn-sm btn-primary  float-right"><i class="fas fa-plus"></i> Add Products</a>
...
<script>
    $(document).on('change','.publish_toggle', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('products.publish_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
    ...
    $(document).on('change','.feature_toggle', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('products.feature_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
    ...
    $(document).on('change','.new_arrival_toggle', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            url: "{{ route('products.new_arrival_change','') }}/"+id,
            dataType: 'json',
            success: function (data) {
